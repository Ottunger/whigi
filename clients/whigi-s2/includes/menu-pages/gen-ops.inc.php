	...
	class c_ws_plugin__s2member_menu_page_gen_ops
	{
		public function __construct()
		{
			...
			if(apply_filters("ws_plugin__s2member_during_gen_ops_page_during_left_sections_display_custom_reg_fields", TRUE, get_defined_vars()))
			{
				...
				echo '<p>Some fields are already built-in by default. The defaults are: <code>*Username*, *Email*, *First Name*, *Last Name*, *Address*</code>.</p>'."\n";

				echo '<p>Custom Fields will appear in your requested data for Whigi, and in User/Member Profiles.</p>';
				echo '<p>To add such custom fields, go to Whigi settings, and add required data.</p>';
			...
			if(apply_filters("ws_plugin__s2member_during_gen_ops_page_during_left_sections_display_login_welcome_page", TRUE, get_defined_vars()))
			{
				...
				echo '<input type="hidden" value="'.get_option('whigi_login_redirect_url').'" name="ws_plugin__s2member_login_welcome_page" id="ws-plugin--s2member-login-welcome-page">'."\n";
				echo '<input type="hidden" value="0" name="ws_plugin__s2member_login_redirection_always_http" id="ws-plugin--s2member-login-redirection-always-http">'."\n";
